...
Il ne suffit plus que de brancher un câble USB à Mini-USB
## Étape 2
...
Ceci correspond au mode "setup", mode qui permet d'intéragir avec la base. Si l'application ne trouve toujours pas la base, vous pouvez appuyer sur le bouton reset pour remettre la base en mode setup. Ceci est une étape importante si vous avez changé le mode.
