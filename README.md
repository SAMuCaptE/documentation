...
Ce répertoire se veut une base de connaissance pour tout ce qui a trait à **SAUM**.
Certains détails plus spécifiques se retrouveront dans le répertoire de chaque projet.

Consulter la [liste de tous les répertoires](https://github.com/orgs/SAMuCaptE/repositories).
